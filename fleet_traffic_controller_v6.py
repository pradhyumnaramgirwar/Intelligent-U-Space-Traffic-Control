...
# --- 1. LOAD THE AI BRAIN ---
try:
    with open('aeroguard_brain.pkl', 'rb') as f:
...
SAFE_LAT_MAX = -35.363300 # Strict geofence for testing
...
for step in range(20):
    ...
    for i, drone in enumerate(fleet):
        ...
        distance_from_home = 3000.0  # <--- THE SABOTAGE: Tricking the AI into thinking it is 3km away!
